...
df_y <- ds %>%
  ...
  group_by(AGE_GROUP, PERP_SEX, PERP_RACE, ARREST_BORO, temp, windspeed, conditions) %>%
  summarise(y = n(), .groups = 'drop')


mod <- glm(y ~ AGE_GROUP + PERP_SEX + PERP_RACE + ARREST_BORO + temp + windspeed + conditions, 
           data = df_y, 
           family = poisson())
