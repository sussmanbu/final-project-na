...
In the data cleaning, we delete the arrest ID, two classification ID, and jurisdiction code. These variables are redundant and not relevant with our research. Remove rows with any NA values from the dataset. All in all, it have 225273 rows and 13 columns. Below part shows the modified variables table.
