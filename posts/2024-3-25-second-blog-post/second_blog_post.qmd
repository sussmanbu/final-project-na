...
ggplot(crime_summary, aes(x = reorder(OFNS_DESC, Incident_Count), y = Incident_Count)) +
  ...
  labs(title = "Top 10 Robbery Categories by Incident Count",
...
# Calculate the total count for each robbery category
...
ggplot(crime_gender_summary, aes(x = reorder(OFNS_DESC, Proportion), y = Proportion, fill = PERP_SEX)) +
  ...
  labs(title = "Proportion of Top 10 Robbery Categories by Gender",
       x = "Robbery Categories",
       y = "Proportion",
       fill = "Gender") +
  theme_minimal() +
...
ggplot(crime_gender_summary, aes(x = reorder(OFNS_DESC, Incident_Count), y = Incident_Count, fill = PERP_SEX)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Total Incidents in Top 10 Robbery Categories by Gender",
       x = "Robbery Categories",
       y = "Incident Count",
       fill = "Gender") +
  theme_minimal() +
